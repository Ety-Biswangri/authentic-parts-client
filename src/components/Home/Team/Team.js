...
const Team = () => {
    return (
        <div className='my-10 lg:mt-20 lg:px-20'>
            <h2 className='text-center lg:text-3xl text-2xl font-bold lg:mb-10 sm:mb-5 uppercase text-primary'>Our Special Team Members</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                ...
                <div class="card lg:max-w-sm sm:max-w-xs bg-base-100 shadow-xl m-3 lg:m-0">
                    <div class="card-body items-center text-center">
                        ...
                        <p className=' text-base font-semibold'> Manufacturing Specialist </p>
                        <p class="flex my-3">
                            <GrFacebook className='mx-3'></GrFacebook>
                            <FaTwitter className='mx-1'></FaTwitter>
                            <GrLinkedin className='mx-3'></GrLinkedin>
